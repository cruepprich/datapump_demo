------------------------------------------------------------------------------------
-- File name: imp_dp_link.prc
-- Purpose:   To demonstrate a datapump import via a database link.
--            Additionally, the procedure only import tables without triggers,
--            and appends data to existing tables.
-- Author:    Christoph Ruepprich
--            http://ruepprich.wordpress.com
--            cruepprich@gmail.com
-- Notes:     For educational purposes only.
--            The database link used in l_db_link must exist to a schma
--            that has exp_full_database privileges.
--            Edit variables l_from_schema, l_to_schema, l_from_ts, l_to_ts
--            as necessary.
------------------------------------------------------------------------------------
