------------------------------------------------------------------------------------
-- File name: exp_schema_basic.prc
-- Purpose:   Perform a datapump schema export
-- Author:    Christoph Ruepprich
--            http://ruepprich.wordpress.com
--            cruepprich@gmail.com
-- Notes:     For educational purposes only. Schema name is hard coded
--            in line 87.
------------------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE exp_schema_basic IS
