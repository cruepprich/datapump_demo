------------------------------------------------------------------------------------
-- File name: exp_stats.prc
-- Purpose:   To demonstrate exporting table and index statistics only.
-- Author:    Christoph Ruepprich
--            http://ruepprich.wordpress.com
--            cruepprich@gmail.com
-- Notes:     For educational purposes only.
--            This procedure can easily be modified to import statistics only
--            by changing the job mode to IMPORT.
------------------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE exp_stats IS
