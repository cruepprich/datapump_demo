------------------------------------------------------------------------------------
-- File name: exp_exclude_objects.prc
...
------------------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE exp_exclude_objects IS
...
BEGIN
  l_job_name := 'exp_exclude_objects';
